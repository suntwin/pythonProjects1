...
class SeleniumExtractor:
  ...
  def __init__(self, url):
    ...
    options.add_experimental_option("prefs", {
      "download.default_directory": "/users/niteshchawla/Ownstuff/pythonProjects/crypto/download/",
      "download.prompt_for_download": False,
      "download.directory_upgrade": True,
      "safebrowsing.enabled": True
    })
    self.url = url
    self.driver = webdriver.Chrome('/users/niteshchawla/Ownstuff/pythonProjects/crypto/chromedriver/chromedriver', chrome_options=options)
